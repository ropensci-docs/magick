...
This enables a
[addTaskCallback](https://rdrr.io/r/base/taskCallback.html) that
automatically updates the viewer after the state of a magick graphics
device has changed. This is enabled by default in RStudio.
